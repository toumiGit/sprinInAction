package spitterProject;//package persistence;
...
// l ordre des variables casse les couilles
public class SimpleJdbcTemplateSpitterDao implements
  ...
  public List<Spitter> findAllSpitters() {
      String req = "select * from spitter";
    List results =  jdbcTemplate.queryForList(req);
    return (List<Spitter>) results;
  }
}
